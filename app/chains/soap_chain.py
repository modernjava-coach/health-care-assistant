...
def get_soap_note_chain(model_id: str = None, region_name: str = None):
    ...
    system_template = """You are an expert medical scribe. Convert raw patient notes into a structured SOAP note.
